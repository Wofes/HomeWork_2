...
public class LoginPage extends AbstractPage {
    ...
    public LoginPage fillTextMessage(String test) throws InterruptedException {
    ...
    public void themeText() throws InterruptedException  {
